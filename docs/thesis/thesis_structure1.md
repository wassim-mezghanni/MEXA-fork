...
- 2.1 Multilingual Language Models 
  ...
  - 2.1.3 Cross-lingual Transfer : How models represent semantic concepts across different languages in a shared space.
  - 2.1.4 English as a Pivot Language : The role of English as a bridge in multilingual LLMs, alignment dynamics, and English centricity/bias.
- 2.2 Multilingual Evaluation 
  - 2.2.1 Standard Benchmarks (FLORES, MMLU)
  - 2.2.2 Reference-Based vs. Reference-Free Metrics : pros and cons of traditional evaluation metrics (BLEU, COMET) vs. model-based metrics.
  - 2.2.3 Challenges in Cross-lingual Alignment Evaluation
