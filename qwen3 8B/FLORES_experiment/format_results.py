...
"""
Format MEXA JSON scores into Dashboard CSV — FLORES-200 dataset.
...
Dataset: FLORES-200 devtest — 100 sentences
"""
...
def main():
    parser = argparse.ArgumentParser("Format MEXA json scores into Dashboard CSV (FLORES — Qwen3 8B Base)")
    ...
    print(f"\n{'='*50}")
    print(f"  FLORES — Qwen3 8B Base Results")
