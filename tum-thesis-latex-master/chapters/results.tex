...
A major driver of low-resource alignment drop is subword tokenization fertility $F_L$, the average number of tokens per word \citep{petrov2023tokenizer}. We find a strong negative correlation between fertility and alignment ($r \in [-0.46, -0.62]$ depending on the model, $p < 10^{-6}$).
