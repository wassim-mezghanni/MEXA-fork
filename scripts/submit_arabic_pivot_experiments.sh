...
EXPERIMENTS=(
    "experiments/llama/llama3.1 8B/FLORES_table1_100_arabic_pivot_experiment"
    "experiments/mistral/mistral 0.3 7B/FLORES_table1_100_arabic_pivot_experiment"
    "experiments/qwen/qwen3 4B/FLORES_table1_100_arabic_pivot_experiment"
    "experiments/qwen/qwen3 8B/FLORES_table1_100_arabic_pivot_experiment"
    "experiments/qwen/qwen3.5 9B/FLORES_table1_100_arabic_pivot_experiment"
)
