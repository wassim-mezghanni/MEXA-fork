...
find experiments -name "*.slurm" | xargs sed -i '' "s|llama3-1-8b-table1-results.csv|full_flores_llama3.1_8b_results.csv|g"
find experiments -name "*.slurm" | xargs sed -i '' "s|llama3-1-8b-bible-table1-results.csv|bible_table1_llama3.1_8b_results.csv|g"
find experiments -name "*.slurm" | xargs sed -i '' "s|mistral-7b-v03-bible-table1-results.csv|bible_table1_mistral_7b_v03_results.csv|g"
