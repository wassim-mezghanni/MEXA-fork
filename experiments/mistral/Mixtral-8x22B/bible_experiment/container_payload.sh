...
CSV_OUTPUT_PATH="$REPO_ROOT/dashboard/public/data/bible_mixtral_8x22b_results.csv"
PROJ_OUTPUT_PATH="$REPO_ROOT/dashboard/public/data/projections_bible_mixtral_8x22b.json"
...
if [ ! -d "$DATA_DIR" ]; then
    ...
    python3 "$REPO_ROOT/download_bible.py" --output_dir "$DATA_DIR" --token "$HF_TOKEN"
    if [ $? -ne 0 ]; then
...
echo "============================================"
echo "  MEXA Bible Full — Mixtral 8x22B (SMoE, 4x H100)"
