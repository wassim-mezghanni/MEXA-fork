...
$SAVE_EMBD_DIR = "C:\mexa_embeddings\Bible_table1"
$SAVE_SCORE_DIR = "./scores"
$LANG_LIST = "../../shared/bible_table1_101.json"
$CSV_OUTPUT_PATH = "../../dashboard/public/data/bible_table1_mixtral_8x22b_results.csv"
...
& $PYTHON_PATH ../../compute_projections.py `
    --embedding_path $SAVE_EMBD_DIR `
    --output_json "../../dashboard/public/data/projections_bible_table1_mixtral_8x22b.json" `
    --embedding_type embd_weighted `
    --num_sents 103 `
    --file_ext .pkl
