...
CSV_OUTPUT_PATH="$REPO_ROOT/dashboard/public/data/flores_table1_2000_mixtral_8x22b_results.csv"
PROJ_OUTPUT_PATH="$REPO_ROOT/dashboard/public/data/projections_flores_table1_2000_mixtral_8x22b.json"
...
echo "============================================"
echo "  MEXA FLORES Table 1 2000 — Mixtral 8x22B (SMoE, 4x H100)"
