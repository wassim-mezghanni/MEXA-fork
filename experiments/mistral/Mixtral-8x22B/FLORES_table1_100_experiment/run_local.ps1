...
$SAVE_EMBD_DIR = "C:\mexa_embeddings\FLORES_table1_100"
$SAVE_SCORE_DIR = "./scores"
$LANG_LIST = "../../shared/flores_table1_116.json"
$CSV_OUTPUT_PATH = "../../dashboard/public/data/flores_table1_100_mixtral_8x22b_results.csv"
...
& $PYTHON_PATH ../../compute_projections.py `
    --embedding_path $SAVE_EMBD_DIR `
    --output_json "../../dashboard/public/data/projections_flores_table1_100_mixtral_8x22b.json" `
    --embedding_type embd_weighted `
    --num_sents 100 `
    --file_ext .pkl
