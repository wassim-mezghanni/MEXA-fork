...
CSV_OUTPUT_PATH="$REPO_ROOT/dashboard/public/data/full_flores_mixtral_8x22b_results.csv"
PROJ_OUTPUT_PATH="$REPO_ROOT/dashboard/public/data/projections_full_flores_mixtral_8x22b.json"
...
echo "============================================"
echo "  MEXA FLORES Full — Mixtral 8x22B (SMoE, 4x H100)"
