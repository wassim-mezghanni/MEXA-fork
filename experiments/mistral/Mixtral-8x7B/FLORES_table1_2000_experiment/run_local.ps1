...
$CSV_OUTPUT_PATH = "../../dashboard/public/data/flores_table1_2000_mixtral_8x7b_results.csv"
...
#     --embedding_path $SAVE_EMBD_DIR `
#     --output_json "../../dashboard/public/data/projections_flores_table1_2000_mixtral_8x7b.json" `
#     --embedding_type embd_weighted `
#     --num_sents 2000 `
#     --file_ext .pkl
