...
values are unreliable in anisotropic LLM embedding spaces, where representations are confined to a narrow cone and dominated by language-specific centroids \citep{ethayarajh2019contextualized,rajaee2022isotropy,hammerl2023anisotropy}.
