...
export default function ApertusFloresTable1_2000Findings() {
  return (
    <ExperimentFindings
      title="Apertus 8B — FLORES Table 1 (1012 sents)"
      description="Reproduction of the MEXA paper's Table 1 setup for Swiss AI's Apertus 8B on FLORES. This subset contains the 116 languages overlapping with the Belebele benchmark, evaluated on the full devtest (1012 sentences). Token-weighted embeddings, Max + Mean pooling."
