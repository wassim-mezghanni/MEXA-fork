...
export default function Qwen3FloresTable1_2000Findings() {
  return (
    <ExperimentFindings
      title="Qwen3 8B Base — FLORES Table 1 (1012 sents)"
      description="Reproduction of the MEXA paper's Table 1 setup for Qwen3 8B Base on FLORES. This subset contains the 116 languages overlapping with the Belebele benchmark, evaluated on the full devtest (1012 sentences). Token-weighted embeddings, Max + Mean pooling."
