...
export default function Qwen306BFloresFindings() {
  return (
    <ExperimentFindings
      ...
      description="MEXA evaluation of Qwen3 0.6B on the full FLORES-200 devtest, 204 languages evaluated on 1012 parallel sentences. Token-weighted embeddings with max and mean pooling across layers."
