...
export default function ApertusMini4BFloresTable1_2000Findings() {
  return (
    <ExperimentFindings
      title="Apertus 4B (v1.1) — FLORES Table 1 (2000 sents)"
      description="Reproduction of the MEXA paper's Table 1 setup for Swiss AI's Apertus-v1.1-4B (Apertus-mini) on FLORES. This subset contains the 116 languages overlapping with the Belebele benchmark, evaluated on the full devtest (2000 sentences). Token-weighted embeddings, Max + Mean pooling."
